...
class ShotTypeTest {
    ...
    @Test
    fun `los dos globos van y vuelven por el cable`() {
        assertEquals(ShotType.FOREHAND_LOB, ShotType.fromWire("forehandLob"))
        assertEquals(ShotType.BACKHAND_LOB, ShotType.fromWire("backhandLob"))
    }
